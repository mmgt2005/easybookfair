...
import { closeWalletsForFair } from "@/app/admin/fairs/[fairId]/wallets/actions";
import { Badge, Button, Card, PageHeader, statusTone } from "@/components/ui";

// Mirrors app/admin/fairs/[fairId]/wallets/page.tsx — same
// closeWalletsForFair Server Action (requireFairStaff() inside it lets org
// staff call it for a fair their own org owns), only the page-level gate
// and explicit org-ownership check differ.
